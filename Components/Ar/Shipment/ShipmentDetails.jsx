...
const ShipmentDetails = ({step,setStep,state,setState,handleDropDownClick,handleChange}) => {
  ...
  return (
    ...
    <h5 className='text-xl text-grey medium-font'>
        ...
        <div className="md:w-[46%]  w-full  gap-x-16 flex"> 
            <ShipmentTextInput masked issue={gVError} handleChange={handleChange} value={state.goodValues} id='goodValues' label={'Declared Goods Value'} info handleClick={handleInfoPopup}/>
        </div>
        <div className="md:w-[46%]  w-full  gap-x-16 flex"> 
